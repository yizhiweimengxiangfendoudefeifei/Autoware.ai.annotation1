...
{
  twist_filter::Configuration twist_filter_config;
  twist_filter_config.lateral_accel_limit = config_msg->lateral_accel_limit;//横向加速度限制
  twist_filter_config.lateral_jerk_limit = config_msg->lateral_jerk_limit;
  twist_filter_config.lowpass_gain_linear_x = config_msg->lowpass_gain_linear_x;//速度的低通滤波系数
  twist_filter_config.lowpass_gain_angular_z = config_msg->lowpass_gain_angular_z;//角速度的低通滤波系数
